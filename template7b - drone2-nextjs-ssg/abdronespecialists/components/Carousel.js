...
const Carousel = ({ children, infinite, noDots, noArrows, className, carouselRef, carouselInitialSlide, fade, asNavFor, notDraggable, notSwipable, adaptiveHeight, arrowsMd }) => {
